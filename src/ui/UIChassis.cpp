...
void ClassicFlangerUI::_drawChassisBackground(float margin, float rounding)
{
    ...
    // Main panel – base colour rgb(64, 70, 97)
    drawList->AddRectFilled(panelMin, panelMax, IM_COL32(64, 70, 97, 0xff), rounding);
...
void ClassicFlangerUI::_drawKjearhusLogo(const ImVec2& size)
{
...
void ClassicFlangerUI::_drawPluginName()
{
    ImGui::BeginGroup();
    ...
    //
    {
        ...
        const ImVec2 o4_sz  = font->CalcTextSizeA(kFontSz, FLT_MAX, 0.0f, "02");
